angular.module('cp').directive('cpVendorProfileForm', function(getTemplateUrl) {
    return {
        restrict: 'E',
        scope: {
...
angular.module('cp').controller('cpVendorProfileFormController', function($scope, $location,
        LoadingService, PackagesFactory, VendorsFactory, NotificationService, $upload, API_BASE,
        ApiService) {
