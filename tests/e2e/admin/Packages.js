describe('Admin - packages page', function() {
    ...
    it('should have 5 rows', function() {
        gridTestUtils.expectRowCount('packages-table', 5);
    });
    ...
    it('should have the column name "Cost"', function() {
        gridTestUtils.expectHeaderCellValueMatch('packages-table', 4, 'Cost');
    });
    ...
    it('should find 5 packages when filter is cancelled', function() {
