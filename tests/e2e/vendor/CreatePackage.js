describe('Vendor portal - create package', function() {
    ...
    it('should be able to create a package', function() {
        var cuisineTypeId = element.all(by.css('#package_cuisine_type option')).get(1).getAttribute('value');
        element(by.model('package.cuisineType')).sendKeys(cuisineTypeId);
        ...
        element(by.model('package.deliveryDays')).sendKeys(['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday']);
