describe('Vendor portal - your addresses', function() {
    ...
    it('should be able to add an address', function() {
        ...
        element(by.model('address.orderNotificationMobileNumbersCommaSeparated')).sendKeys('07111222333');
    ...
    it('should be able to edit an address', function() {
        ...
        element(by.model('address.orderNotificationMobileNumbersCommaSeparated')).clear().sendKeys('07123456789, 07321654987');
